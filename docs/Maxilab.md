...
<div style="align: left; text-align:center;">
    <img src="images/IGW_mixing.jpeg" width="100%" /> 
    <div class="caption" style="width: 800"> 2D hydrodynamical simulation of the generation of internal gravity waves from a convective boundary (left), and a schematic of a resulting envelope mixing profile from internal gravity waves generated by the convective core (right). Credit: Tamara Rogers (left) & May G. Pedersen (right). </div>
</div>
