...
**Solution:** In case you get stuck at any point during the exercises, then you can download the solution to minilab 1 from [here](https://github.com/MichielsenM/mesa-summer-school-2023/tree/Lynn_mods/solutions/SPB_minilab1_solutions){:target="_blank"}.
